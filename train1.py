...
SOURCE = '/content/drive/MyDrive/training_us_soybean_corn_belt_sheir' ## update this for new data source
JOB_FOLDER = 'busan1'  ## update this for new models
JOB_DIR = JOB_FOLDER + '/trainer'
MODEL_DIR = '/content/drive/MyDrive/busan_model_new1'
...
if SOURCE == 's2-data':
  ...
  opticalBands = ['blue','green','red','nir','swir1','swir2','ndvi','nirv','blue_1','green_1','red_1','nir_1','swir1_1','swir2_1','ndvi_1','nirv_1']
thermalBands = []
